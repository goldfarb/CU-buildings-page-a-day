...
function setup() {
  ...
  img_r.loadPixels();
      ...
      for (let i = 0; i < img_r.pixels.length; i += 4) {
        ...
        img_r.pixels[i] = 4;   // New R
        img_r.pixels[i + 1] = 236; // New G
        img_r.pixels[i + 2] = 243; // New B
    }
  img_r.updatePixels();
  ...
  img_m.loadPixels();
      ...
      for (let i = 0; i < img_m.pixels.length; i += 4) {
        ...
        img_m.pixels[i] = 53;   // New R
        img_m.pixels[i + 1] = 100; // New G
        img_m.pixels[i + 2] = 126; // New B
    }
  img_m.updatePixels();
  ...
  img_l.loadPixels();
      ...
      for (let i = 0; i < img_l.pixels.length; i += 4) {
        ...
        img_l.pixels[i] = 141;   // New R
        img_l.pixels[i + 1] = 115; // New G
        img_l.pixels[i + 2] = 52; // New B
    }
  img_l.updatePixels();
