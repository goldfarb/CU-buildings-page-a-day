...
function setup() {
  ...
  img_r.loadPixels();
      ...
      for (let i = 0; i < img_r.pixels.length; i += 4) {
        ...
        img_r.pixels[i] = 135;   // New R
        img_r.pixels[i + 1] = 47; // New G
        img_r.pixels[i + 2] = 121; // New B
    }
  img_r.updatePixels();
  ...
  img_m.loadPixels();
      ...
      for (let i = 0; i < img_m.pixels.length; i += 4) {
        ...
        img_m.pixels[i + 1] = 25; // New G
        img_m.pixels[i + 2] = 112; // New B
    }
  img_m.updatePixels();
  ...
  img_l.loadPixels();
      ...
      for (let i = 0; i < img_l.pixels.length; i += 4) {
        ...
        img_l.pixels[i] = 9;   // New R
        img_l.pixels[i + 1] = 111; // New G
        img_l.pixels[i + 2] = 174; // New B
    }
  img_l.updatePixels();
