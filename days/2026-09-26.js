...
function setup() {
  ...
  img_r.loadPixels();
      ...
      for (let i = 0; i < img_r.pixels.length; i += 4) {
        ...
        img_r.pixels[i] = 18;   // New R
        img_r.pixels[i + 1] = 150; // New G
        img_r.pixels[i + 2] = 234; // New B
    }
  img_r.updatePixels();
  ...
  img_l.loadPixels();
      ...
      for (let i = 0; i < img_l.pixels.length; i += 4) {
        ...
        img_l.pixels[i] = 162;   // New R
        img_l.pixels[i + 1] = 164; // New G
        img_l.pixels[i + 2] = 163; // New B
    }
  img_l.updatePixels();
