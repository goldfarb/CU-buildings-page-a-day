...
function setup() {
  ...
  img_r.loadPixels();
      ...
      for (let i = 0; i < img_r.pixels.length; i += 4) {
        ...
        img_r.pixels[i] = 9;   // New R
        img_r.pixels[i + 1] = 221; // New G
        img_r.pixels[i + 2] = 64; // New B
    }
  img_r.updatePixels();
  ...
  img_m.loadPixels();
      ...
      for (let i = 0; i < img_m.pixels.length; i += 4) {
        ...
        img_m.pixels[i] = 173;   // New R
        img_m.pixels[i + 1] = 130; // New G
        img_m.pixels[i + 2] = 161; // New B
    }
  img_m.updatePixels();
