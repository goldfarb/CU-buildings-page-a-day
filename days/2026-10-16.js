...
function setup() {
  ...
  img_r.loadPixels();
      ...
      for (let i = 0; i < img_r.pixels.length; i += 4) {
        ...
        img_r.pixels[i] = 33;   // New R
        img_r.pixels[i + 1] = 77; // New G
        img_r.pixels[i + 2] = 157; // New B
    }
  img_r.updatePixels();
  ...
  img_l.loadPixels();
      ...
      for (let i = 0; i < img_l.pixels.length; i += 4) {
        ...
        img_l.pixels[i] = 86;   // New R
        img_l.pixels[i + 1] = 90; // New G
        img_l.pixels[i + 2] = 92; // New B
    }
  img_l.updatePixels();
